  ...
  return (
    <div className="main__container">
      ...
      <div className="main__social-list">
        <a href="https://github.com/jardlml" target="_blank" rel="noopener noreferrer">
          <img src={github} alt="Up" />
        </a>
        <a href="https://www.instagram.com/jardlml/" target="_blank" rel="noopener noreferrer">
          <img src={insta} alt="Up" />
        </a>
        <a href="https://www.linkedin.com/in/javier-rojas-43324b143/" target="_blank" rel="noopener noreferrer">
